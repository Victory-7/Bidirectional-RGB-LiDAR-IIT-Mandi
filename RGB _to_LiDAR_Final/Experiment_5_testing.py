...
KITTI_PATH = "/DATA/suhani/kitti_object/testing"
...
# ================================================================
# REDUCE POINTS EVENLY
# ================================================================

def reduce_points_evenly(points):

    total_points = len(points)

    target_points = int(
        total_points * (1.0 - POINT_REDUCTION)
    )
...
for image_path in tqdm(image_files):
    ...
    point_cloud = reduce_points_evenly(
        point_cloud
    )
